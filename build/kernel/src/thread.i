...
# 39 "rt-thread\\src\\thread.c" 2
# 1 "c:\\rt-threadstudio\\repo\\extract\\toolchain_support_packages\\wch\\risc-v-gcc-wch\\8.2.0\\lib\\gcc\\riscv-none-embed\\8.2.0\\include\\stddef.h" 1 3 4
# 40 "rt-thread\\src\\thread.c" 2
...
# 67 "rt-thread\\src\\thread.c"
void rt_thread_suspend_sethook(void (*hook)(rt_thread_t thread))
{
    rt_thread_suspend_hook = hook;
}
# 79 "rt-thread\\src\\thread.c"
void rt_thread_resume_sethook(void (*hook)(rt_thread_t thread))
{
...
# 674 "rt-thread\\src\\thread.c"
rt_err_t rt_thread_delay(rt_tick_t tick)
{
    return rt_thread_sleep(tick);
}
;
# 690 "rt-thread\\src\\thread.c"
rt_err_t rt_thread_delay_until(rt_tick_t *tick, rt_tick_t inc_tick)
{
    rt_base_t level;
    struct rt_thread *thread;
