...
# 1 "rt-thread\\components\\libc\\compilers\\common\\ctime.c"
# 27 "rt-thread\\components\\libc\\compilers\\common\\ctime.c"
...
# 16 "rt-thread\\components\\libc\\compilers\\common\\include/sys/time.h" 2
...
# 17 "rt-thread\\components\\libc\\compilers\\common\\include/sys/time.h" 2
...
# 18 "rt-thread\\components\\libc\\compilers\\common\\include/sys/time.h" 2
...
# 28 "rt-thread\\components\\libc\\compilers\\common\\ctime.c" 2
...
# 16 "rt-thread\\components\\drivers\\include/rtdevice.h" 2
...
#define __RTC_H__ 
# 24 "rt-thread\\components\\drivers\\include/drivers/rtc.h"
...
# 30 "rt-thread\\components\\libc\\compilers\\common\\ctime.c" 2
# 1 "rt-thread\\components\\drivers\\include/drivers/rtc.h" 1
# 31 "rt-thread\\components\\libc\\compilers\\common\\ctime.c" 2
...
# 32 "rt-thread\\components\\libc\\compilers\\common\\ctime.c" 2
# 1 "rt-thread\\components\\libc\\compilers\\common\\include/unistd.h" 1
# 12 "rt-thread\\components\\libc\\compilers\\common\\include/unistd.h"
#define UNISTD_H__ 

# 1 "rt-thread\\components\\libc\\compilers\\common\\include/sys/unistd.h" 1
# 13 "rt-thread\\components\\libc\\compilers\\common\\include/sys/unistd.h"
#define __SYS_UNISTD_H__ 

# 1 "c:\\rt-threadstudio\\repo\\extract\\toolchain_support_packages\\wch\\risc-v-gcc-wch\\8.2.0\\lib\\gcc\\riscv-none-embed\\8.2.0\\include\\stddef.h" 1 3 4
# 16 "rt-thread\\components\\libc\\compilers\\common\\include/sys/unistd.h" 2
...
# 31 "rt-thread\\components\\libc\\compilers\\common\\include/sys/unistd.h"
...
gid_t getgid(void);
gid_t getegid(void);
# 15 "rt-thread\\components\\libc\\compilers\\common\\include/unistd.h" 2
# 33 "rt-thread\\components\\libc\\compilers\\common\\ctime.c" 2
# 43 "rt-thread\\components\\libc\\compilers\\common\\ctime.c"
#define DBG_TAG "time"
...
# 46 "rt-thread\\components\\libc\\compilers\\common\\ctime.c" 2
...
__attribute__((aligned(8))) static const char *days = "Sun Mon Tue Wed Thu Fri Sat ";
__attribute__((aligned(8))) static const char *months = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec ";
...
struct tm *gmtime_r(const time_t *timep, struct tm *r)
{
    ...
    {
        rt_set_errno(
# 125 "rt-thread\\components\\libc\\compilers\\common\\ctime.c" 3
                    14
# 125 "rt-thread\\components\\libc\\compilers\\common\\ctime.c"
                          );
        return 0;
    }
...
char* asctime_r(const struct tm *t, char *buf)
{
    ...
    {
        rt_set_errno(
# 204 "rt-thread\\components\\libc\\compilers\\common\\ctime.c" 3
                    14
# 204 "rt-thread\\components\\libc\\compilers\\common\\ctime.c"
                          );
        return 0;
    }
...
;
# 293 "rt-thread\\components\\libc\\compilers\\common\\ctime.c"
__attribute__((weak)) time_t time(time_t *t)
{
    time_t _t;

    if (_control_rtc((((RT_Device_Class_RTC + 1) * 0x100) + 0x01), &_t) != 0)
    {
        rt_set_errno(
# 299 "rt-thread\\components\\libc\\compilers\\common\\ctime.c" 3
                    14
# 299 "rt-thread\\components\\libc\\compilers\\common\\ctime.c"
                          );
        return (time_t)-1;
    }
...
int stime(const time_t *t)
{
    if ((t != 0) && (_control_rtc((((RT_Device_Class_RTC + 1) * 0x100) + 0x02), (void *)t) == 0))
    {
        return 0;
    }

    rt_set_errno(
# 323 "rt-thread\\components\\libc\\compilers\\common\\ctime.c" 3
                14
# 323 "rt-thread\\components\\libc\\compilers\\common\\ctime.c"
                      );
    return -1;
}
;
...
time_t timegm(struct tm * const t)
{
    ...
    {
        rt_set_errno(
# 336 "rt-thread\\components\\libc\\compilers\\common\\ctime.c" 3
                    14
# 336 "rt-thread\\components\\libc\\compilers\\common\\ctime.c"
                          );
        return (time_t)-1;
    }
    ...
    {
        rt_set_errno(
# 378 "rt-thread\\components\\libc\\compilers\\common\\ctime.c" 3
                    22
# 378 "rt-thread\\components\\libc\\compilers\\common\\ctime.c"
                          );
        return (time_t) -1;
    }
...
int gettimeofday(struct timeval *tv, struct timezone *tz)
{
    ...
    if (tv != 0)
    {
        ...
        if (_control_rtc((((RT_Device_Class_RTC + 1) * 0x100) + 0x03), tv) == 0)
            return 0;
    }

    rt_set_errno(
# 435 "rt-thread\\components\\libc\\compilers\\common\\ctime.c" 3
                22
# 435 "rt-thread\\components\\libc\\compilers\\common\\ctime.c"
                      );
    return -1;
}
;
...
int settimeofday(const struct timeval *tv, const struct timezone *tz)
{
    ...
    if (tv != 0 && tv->tv_usec >= 0 && tv->tv_sec >= 0)
    {
        if (_control_rtc((((RT_Device_Class_RTC + 1) * 0x100) + 0x04), (void *)tv) == 0)
            return 0;
    }

    rt_set_errno(
# 453 "rt-thread\\components\\libc\\compilers\\common\\ctime.c" 3
                22
# 453 "rt-thread\\components\\libc\\compilers\\common\\ctime.c"
                      );
    return -1;
}
;
# 1138 "rt-thread\\components\\libc\\compilers\\common\\ctime.c"
